...
&ensp;&ensp;&ensp;&ensp;本文不讲解任何和Zero Extension相关的详细配置信息，那是另外一个故事，而本文中使用的配置地图部分以1.0版为主，可能和本系列教程中的内容不一致。
...
![](./_image/2021-08-09/2021-08-09-17-56-48.png)
...
![](./_image/2021-08-09/2021-08-09-18-10-51.png)
...
&ensp;&ensp;&ensp;&ensp;上述配置在打开了session节点时生效。
